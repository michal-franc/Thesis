...
W niniejszej pracy dyplomowej zdecydowano siê zastosowaæ framework \textbf{NHibernate} \cite{NHibernate}. Jest to rozwi¹zanie bêd¹ce implementacj¹ frameworka \textbf{Hibernate} dostêpnego w œrodowisku \textbf{Javy} na potrzeby œrodowiska \textbf{.NET}.
