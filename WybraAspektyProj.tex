...
- modu³ raportów i statystyk
- przy bardziej z³o¿onych kursach œcie¿ka kszta³cenia
...
-dodatkowo w platformie laczacej rownie¿ system ERP i kompetencje pracownicze
 mo¿na zrobiæ modu³ rekomendacji pracowniczych oceny pracowników , narzedzia wspomagajace planowanie szkolen dla zespolow pro

\section{Architektura systemów zdalnego nauczania}

Baza Danych + Logika + UI
\section{Sposoby komunikacji z u¿ytkownikiem koñcowym}
!!
\section{Bezpieczeñstwo systemu}
!!
\section{SOA - Architektura zorientowana na us³ugi}
!!
\section{Projektowanie us³ug sieciowych w œrodowisku .Net}
!!
